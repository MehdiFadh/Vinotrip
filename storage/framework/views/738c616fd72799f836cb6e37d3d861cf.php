...
<div class="sejour-detail-container">
    ...
    <form id="panier-form" action="<?php echo e(route('panier.ajouter.article')); ?>" method="POST">
        ...
        <input type="date" name="date_sejour" id="date" min="<?php echo e(date('d/m/Y')); ?>" value="<?php echo e(date('Y-m-d')); ?>">
        ...
        <div class="total-section">
            <strong>Prix Total :</strong> <span id="prix-total"><?php echo e($sejour->prix_sejour); ?> €</span>
        </div>
    ...
    <script>
        const prixSejour = <?php echo e($sejour->prix_sejour); ?>; // Prix de base du séjour

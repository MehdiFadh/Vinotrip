        ...
        <header>
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    @endauth
                    @auth
                    @if(auth()->check() && auth()->user()->role === 'service_marketing')
                        <li><a href="{{ route('sejours.en_attente2') }}">Séjours à compléter</a></li>                   
                    @endif
                    @endauth
                    @auth
                    @if(auth()->check() && auth()->user()->role === 'dirigeant')
                        <li><a href="/commandesEffectif-affichage">Toutes les commandes</a></li>
                        <li><a href="{{ route('rapport.ventes') }}">Rapport</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="{{ route('cheque-cadeau') }}">Chèque cadeau</a>
                        </div>
                    </li>
